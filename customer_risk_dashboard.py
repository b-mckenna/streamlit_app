...
# Page header
st.title("Customer Risk Dashboard", anchor=None)
...
with churn_col:
    # Count how many customer's in the adjusted dataframe are within the churn prediction threshold
...
##### Details about the customers predicted to churn
st.header("Customers at risk of churning")

# Sort rows by churn probability and move the prediction score column to the left
